...
export function HomeLayout() {
    return (
        <FullScreenBackground>
            <div className="relative p-6 md:p-10 w-fit">
                <div className="absolute inset-0 bg-primaryColor opacity-30 rounded-xl"></div>

                <div className="relative flex flex-col text-white h-full justify-center space-y-10 px-10 md:px-0">
